function ID = getErrorID(code)

% ID is a char array that has the following structure: 'CCCC:CCCC'
% This is mainly used by MATLAB for error identification.
% If you need a unique error ID (as a number) see getErrorCodes()
