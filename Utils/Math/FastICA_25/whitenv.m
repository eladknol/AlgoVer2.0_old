...
if any (diag (D) < 0),
    if(coder.target('matlab'))
        ...
        error('negative eigenvalues computed from the covariance matrix. These are due to rounding errors in Matlab (the correct eigenvalues are probably very small)');
    end
end
