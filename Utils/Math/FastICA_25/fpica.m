...
switch lower(approach)
    ...
    otherwise
        if(coder.target('matlab'))
            ...
            error('Illegal value for parameter: ''approach'' ');
        end
end
...
switch lower(g)
    ...
    otherwise
        if(coder.target('matlab'))
            ...
            error('Illegal value for parameter: ''g''');
        end
end
if sampleSize ~= 1
    gOrig = gOrig + 2;
...
switch lower(finetune)
    ...
    otherwise
        if(coder.target('matlab'))
            ...
            error('Illegal value for parameter: ''finetune''');
        end
end
...
switch lower(stabilization)
    ...
    otherwise
        if(coder.target('matlab'))
            ...
            error('Illegal value for parameter: ''stabilization''');
        end
end
...
switch lower(initState)
    ...
    otherwise
        if(coder.target('matlab'))
            ...
            error('Illegal value for parameter: ''initState''');
        end
end
...
switch lower(displayMode)
    ...
    otherwise
        if(coder.target('matlab'))
            ...
            error('Illegal value for parameter: ''displayMode''');
        end
end
